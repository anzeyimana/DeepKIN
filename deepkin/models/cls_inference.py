...
# @Workstation-PC
from deepkin.models.kinyabert import KinyaBERT_SequenceClassifier, KinyaBERT_from_pretrained
...
def GLUE_eval_main(args, cfg: BaseConfig):
    ...
    cls_model = KinyaBERT_SequenceClassifier(args, cfg, num_classes)
